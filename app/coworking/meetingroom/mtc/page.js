    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Meeting Room Type C</h1>
            <h2 className="text-xl text-gray-700">ห้องประชุมขนาดใหญ่ (จำนวน {rooms.length} ห้อง)</h2>
          </div>
          {user && (
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-600 mb-6">
            <li className="flex items-start">
              <span className="mr-2">•</span> ความจุ 20 คน
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span> โต๊ะประชุมทรงยาวพร้อมเก้าอี้นวม
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span> จอแสดงผล 75 นิ้ว จำนวน 2 จอ
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span> ระบบเสียงคุณภาพสูงรอบทิศทาง
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span> ไวไฟความเร็วสูง
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span> ระบบประชุมทางไกลพร้อมกล้องความละเอียดสูง
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span> ไวท์บอร์ดอิเล็กทรอนิกส์
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span> เครื่องฉายโปรเจคเตอร์
            </li>
            <li className="flex items-start">
              <span className="mr-2">•</span> มุมเครื่องดื่มและอาหารว่าง
            </li>
          </ul>
          ...
          <ul className="space-y-2 text-gray-600">
            ...
            <li className="flex items-start">
              <span className="mr-2">•</span> สามารถจัดเตรียมบริการอาหารและเครื่องดื่มเพิ่มเติมได้ (มีค่าใช้จ่ายเพิ่มเติม)
            </li>
          </ul>
        </div>
        ...
        {rooms.length === 0 && (
          <div className="bg-yellow-50 border border-yellow-200 text-yellow-800 rounded-lg p-4 mb-8">
            <p>ไม่พบห้องประชุมประเภท C ที่ว่างในขณะนี้ กรุณาตรวจสอบอีกครั้งในภายหลัง</p>
          </div>
        )}
      </div>
